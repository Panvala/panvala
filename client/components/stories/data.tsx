...
export const epochStartDate = 1549040400; // Feb 1, 2019 12PM EDT
export const currentBallot = ballotDates(epochStartDate);
export const baseBallot = {
  epochNumber: 0,
  finalityDate: 1556902800,
  initialSlateSubmissionDeadline: 1552366800,
  slateSubmissionDeadline: { GRANT: 0, GOVERNANCE: 0 },
  startDate: 1549040400,
  votingCloseDate: 1556298000,
  votingOpenDate: 1555693200,
};

const baseProposals: IProposal[] = [
  {
    id: 0,
    category: 'GRANT',
    firstName: 'Amanda',
