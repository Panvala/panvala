...
Scenario: Slate Submission
  When I enter the epoch "1" on the Panvala Time Travel page
...
Scenario: Intermission
  When I enter the epoch "2" on the Panvala Time Travel page
...
Scenario: Commit Voting
  When I enter the epoch "3" on the Panvala Time Travel page
...
Scenario: Reveal Voting
  When I enter the epoch "4" on the Panvala Time Travel page
